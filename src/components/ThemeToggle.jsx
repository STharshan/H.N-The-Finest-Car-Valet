  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold transition-all duration-200 ${
        isDark
          ? "border-[rgba(201,206,214,0.22)] bg-[rgba(255,255,255,0.06)] text-white hover:bg-[rgba(255,255,255,0.1)]"
          : "border-[rgba(11,31,58,0.14)] bg-white text-[#0b1f3a] hover:bg-[#f5f7fa]"
